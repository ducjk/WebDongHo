...
<body>
	...
	<% 	
		...
		if (errorMessage != null){
			%>
			<script type="text/javascript">alert("Thêm đồng hồ thất bại")</script>
	...
	<div class="main">
		...
		<h3 class="heading">Thêm đồng hồ</h3>
          ...
          <div class="form-group">
            ...
            <input id="txttendongho" name="txttendongho" type="text" placeholder="Đồng hồ ABC" class="form-control">
            <span class="form-message"></span>
          </div>
          <div class="form-group">
          ...
          <div class="form-group">
            ...
            <input id="txtsoluong" name="txtsoluong" type="number" min="1" placeholder="Nhập số lượng" class="form-control">
            <span class="form-message"></span>
          </div>
          <div class="form-group">
            <label for="txtgia" class="form-label">Giá</label>
            <input id="txtgia" name="txtgia" type="text" min="1000" placeholder="Nhập giá" class="form-control">
            <span class="form-message"></span>
          </div>
          <div class="form-group">
            <label for="txtxuatxu" class="form-label">Xuất xứ</label>
            <input id="txtxuatxu" name="txtxuatxu" type="text" placeholder="Nhập xuất xứ" class="form-control">
            <span class="form-message"></span>
          </div>
           <div class="form-group">
