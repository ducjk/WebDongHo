                        ...
                        <% } else { %>
	                        ...
	                        <li class="navbar-item navbar-item-user">
	                            ...
	                            <ul class="navbar-item-user-list">
	                                ...
	                                <li class="navbar-item--list-item">
	                                    <a href="<%=kh == null ? "ktdn" : "lichsumuahang"%>">Đơn mua</a>
	                                </li>
                        ...
                        <div class="header__cart-wrap">
                            ...
                            <div class="header__cart-list ">
                             ...
                             <!-- Has Cart -->
                                ...
                                <% if(gh != null) if (gh.ds.size() == 0){ out.print("Không có sản phẩm nào trong giỏ");}else{
                                	for (giohangbean item: gh.ds){
                                	%>
                                
                                    <li class="header__cart-item">
                                        <img src="<%=item.getAnh() %>" alt="<%=item.getTenDongHo() %>" class="header__cart-item-img">
                                        <div class="header__cart-item-content">
                                            <div class="header__cart-item-header">
                                                <h5 class="header__cart-item-name"><%=item.getTenDongHo() %></h5>
                                                <div class="header__cart-item-wrap">
                                                    <span class="header__cart-item-price"><%=item.getGia() %></span>
                                                    <span class="header__cart-item-multiply">x</span>
                                                    <span class="header__cart-item-quantity"><%=item.getSoLuong() %></span>
                                                </div>
                                            </div>
                                            <div class="header__cart-item-body">
                                                <span class="header__cart-item-description"><%=item.getXuatXu() %></span>
                                            </div>
                                        </div>
                                    </li>
                                    <%}} %>
                ...
                <div class="row sm-gutter app__content">
                    <div class="col l-2 m-0 c-0">
                        <nav class="category">
                            ...
                            <!-- add class category-item__active for li when category active -->
                            	<%
									...
									ArrayList<loaibean> loai = (ArrayList<loaibean>)request.getAttribute("dsloai");
										for(loaibean l: loai){%>		
											<li class="category-item">
                                    			<a href="htdongho?ml=<%=l.getMaLoai()%>" class="category-item__link"><%=l.getTenLoai()%></a>
                                			</li>
										<%
										}
								%>
                    ...
                    <div class="col l-10 m-12 c-12">
                        <div class="home-filter hide-on-mobile-tablet">
                            ...
                            <div class="home-filter__page">
                                ...
                                /
                                <span class="page__number-2">14</span>
                                <div class="home-filter__control">
                                    <a href="" class="page__btn page__btn-disabled ">
                                        <i class="page__btn-icon fas fa-angle-left"></i>
                                    </a>
                                    <a href="" class="page__btn">
                                        <i class="page__btn-icon fas fa-angle-right"></i>
                        ...
                        <nav class="mobile__category">
                            <ul class="mobile__category-list">
                                <li class="mobile__category-item">
                                    <a href="" class="mobile__category-link">Dụng cụ & Thiết bị tiện ích Dụng cụ & Thiết bị tiện ích</a>
                                </li>
                                <li class="mobile__category-item">
                                    <a href="" class="mobile__category-link">Dụng cụ & Thiết bị tiện ích</a>
                                </li>
                                <li class="mobile__category-item">
                                    <a href="" class="mobile__category-link">Dụng cụ & Thiết bị tiện ích</a>
                                </li>
                        ...
                        <div class="home-product">
                            ...
                            <%
		     				ArrayList<donghobean> dsdongho = (ArrayList<donghobean>) session.getAttribute("dsdongho");
		     				if (dsdongho.size() == 0){
		     				%>
		     					<h1>Không có đồng hồ loại này</h1>
			     			<%}else{
					   		    int n = dsdongho.size();
					   		    for(int i=0; i<n ;i++){
                                ...
                                <div class="col l-2-4 m-4 c-6">
                                    <a class="home-product__item" href="giohang?addwatch=true&ms=<%=s.getMaDongHo()%>&tendongho=<%=s.getTenDongHo()%>&gia=<%=s.getGia()%>&anh=<%=s.getAnh()%>&xuatxu=<%=s.getXuatXu() %>">
                                        <div class="home-product__item__img" style="background-image: url(<%=s.getAnh() %>);"></div>
                                        <h4 class="home-product__item__name"><%=s.getTenDongHo() %></h4>
                                        <div class="home-product__item__price">
                                            <span class="home-product__item__price-old"><%=s.getGia() + 100000 %></span>
                                            <span class="home-product__item__price-new"><%=s.getGia() %></span>
                                        </div>
                                        <div class="home-product__item__action">
                                            <span class="home-product__item__like home-product__item__liked">
                                                <i class="home-product__item__like-nolike far fa-heart"></i>
                                                <i class="home-product__item__like-like fas fa-heart"></i>
                                            </span>
                                            <div class="home-product__item__rating">
                                                <i class="home-product__item__rating-star-gold fas fa-star"></i>
                                                <i class="home-product__item__rating-star-gold fas fa-star"></i>
                                                <i class="home-product__item__rating-star-gold fas fa-star"></i>
                                                <i class="home-product__item__rating-star-gold fas fa-star"></i>
                                            ...
                                            <span class="home-product__item__sold">Còn <%=s.getSoLuong() %></span>
                                        </div>
                                        <div class="home-product__item__oringin">
                                            <span class="home-product__item__brand">Ohui</span>
                                            <span class="home-product__item__origin-name"><%=s.getXuatXu() %></span>
                                        </div>
                                        <div class="home-product__item__favourite">
                                            <i class="fas fa-check"></i>
                                            <span>Yêu thích</span>
                                        </div>
                                        <div class="home-product__item__sale-off">
                                            <span class="home-product__item__sale-off--pecent">43%</span>
                                            <span class="home-product__item__sale-off--label">GIẢM</span>
                                        </div>
                                    </a>
